...
const HeroSection = () => {
    ...
    return (
        <section id="top" className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-terracota selection:bg-white/20">
            ...
            <div className="relative z-20 flex flex-col items-center text-center px-6">
                ...
                >
                    <div className="flex flex-col items-center md:items-end">
                        <span className="text-white font-extralight italic font-serif text-2xl md:text-[2.75rem] tracking-tight leading-none mb-1">{t('hero.osvaldo')}</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        <span className="text-white font-extralight italic font-serif text-2xl md:text-[2.75rem] tracking-tight leading-none mb-1">{t('hero.artur')}</span>
                    </div>
                </motion.div>
